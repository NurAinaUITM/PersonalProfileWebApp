 ...
 */
package talentandart;

/**
 *
 * @author NurAinaNajwaNorDaumi
 */
public class TalentPortfolio extends javax.swing.JFrame {

    /**
     * Creates new form TalentPortfolio
     */
    public TalentPortfolio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setName("Talent Portfolio"); // NOI18N

        jLabel1.setText("Talent ID");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Talent ID", "Talent type", "Full Name", "Phone", "Email"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TalentPortfolio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TalentPortfolio().setVisible(true);
            }
        });
    }
